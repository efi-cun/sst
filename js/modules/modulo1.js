    ...
    secciones: [
        {
            ...
            contenido: () => `
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube-nocookie.com/embed/QulvLXsSR0o" referrerpolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"></iframe>
                </div>
        ...
        },
        {
            ...
            contenido: () => `
                ...
                <div class="icon-stats">
                    ...
                    <div class="icon-stat anim-glow" style="animation-delay:0.2s; cursor:pointer;" onclick="App.openVideoPopup('AURORA Seguros de Vida — Nuestra ARL', 'https://www.youtube.com/watch?v=R0ZvPEwLYQ4')">
                        <div class="icon-stat-icon">🏥</div>
        ...
        },
        {
            ...
            contenido: () => `
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube-nocookie.com/embed/W2-vvKhD8O4" referrerpolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"></iframe>
                </div>
